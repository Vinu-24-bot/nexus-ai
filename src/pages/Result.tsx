...
const NativeForgePlayer = ({ src }: { src: string }) => {
  ...
  return (
    <div className="relative w-full aspect-video bg-black rounded-t-lg overflow-hidden flex items-center justify-center">
      {isBuffering && (
    ...
    <div className="min-h-screen bg-background nexus-grid pb-20">
      ...
      <div className="container mx-auto px-6 pt-24 pb-16 max-w-5xl">
        <motion.div initial="hidden" animate="visible" className="space-y-8">
          ...
          {/* 🛡️ Interview Recordings with the Native WebM RAM Fix */}
          {videoFiles.length > 0 && (
            <motion.div variants={fadeUp} custom={2.5} className="glass rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-mono text-muted-foreground bg-muted px-2 py-1 rounded border border-border/50">Native Engine</span>
              </div>
