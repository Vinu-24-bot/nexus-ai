        ...
        <motion.div initial="hidden" animate="visible" className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <motion.div variants={fadeUp} custom={2} className="space-y-2">
              ...
              <Textarea
                placeholder="Paste the job description here, or click 'let ForgePro write one' above..."
            ...
            <motion.div variants={fadeUp} custom={5} className="space-y-2">
              ...
              <Textarea
                ...
                className="bg-card border-border min-h-[160px] resize-none focus-visible:ring-accent"
              />
            </motion.div>
